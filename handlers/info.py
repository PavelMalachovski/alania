...
CHANNEL_TEXT = (
    ...
    "В своем канале я делюсь полезными материалами и практиками, "
    "ченнелингами и энергиями месяца. Они помогут тебе гармонизировать "
    "состояние, найти ответы на вопросы даже раньше, чем они у тебя возникнут ✦"
)
